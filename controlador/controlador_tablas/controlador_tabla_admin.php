        ...
        switch($accion){
            ...
            case "btnAgregar":
                ...
                if(mysqli_num_rows($result) > 0){
                    ...
                    $insert = "INSERT INTO administrador(dni_adm, nombre_adm, apellido_adm, genero_adm, direccion_adm, telefono_adm, email,password, user_type) VALUES('$dni_adm','$nombre_adm','$apellido_adm','$genero_adm','$direccion_adm','$telefono_adm','$email','$pass','$user_type')";
            ...
            case "btnModificar":
                    //COMPLETADO.
                    $update = "UPDATE administrador SET dni_adm='$dni_adm', nombre_adm='$nombre_adm', apellido_adm='$apellido_adm', genero_adm='$genero_adm', direccion_adm='$direccion_adm', telefono_adm='$telefono_adm', email='$email' WHERE id_adm='$id_adm'";
