...
<body id="page-top">
    ...
    <div class="container">
        <?php
        @include '../../../controlador/controlador_tablas/controlador_tabla_producto_colab.php';
        ...
        <form action="../../../controlador/controlador_tablas/controlador_tabla_producto_colab.php" method="post">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-9 d-flex justify-content-sm-end mb-4">
                    <a href="pdfs/pdf_productos_colab.php" class="btn btn-danger btn-sm shadow-sm" style="padding: 8px 15px; font-family: Verdana, Geneva, Tahoma, sans-serif;">
