...
<body id="page-top">
    ...
    <div class="container">
        <?php
        include '../../../controlador/controlador_tablas/controlador_tabla_categoria.php';
        $select = "SELECT * FROM categoria";
        $tabla = mysqli_query($conn, $select);
        ?>

        <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; text-align: center; font-weight: 600;">TABLA CATEGORIA</h3>
        <hr>

        <form action="../../../controlador/controlador_tablas/controlador_tabla_categoria.php" method="post">
            <!-- Modal -->
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="id_categoria" id="id_categoria" value="<?php echo $id_categoria; ?>" readonly><br>
                                </div>
                                ...
                                <div class="form-group col-md-8">
                                    ...
                                    <input type="text" class="form-control" required name="nombre_categoria" placerholder="" id="nombre_categoria" value="<?php echo $nombre_categoria; ?>"><br>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-9 d-flex justify-content-sm-end mb-4">
                    <a href="pdfs/pdf_admin.php" class="btn btn-danger btn-sm shadow-sm" style="padding: 8px 15px; font-family: Verdana, Geneva, Tahoma, sans-serif;">
