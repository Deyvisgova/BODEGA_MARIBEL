...
<section>
<h2>Búsqueda de Guía de Entrada</h2>
...
<section>
            ...
            <div class="col-12 col-sm-9 d-flex justify-content-sm-end mb-4">
                ...
                <a href="pdfs/pdf_Guia_entrada_Uni.php?id=<?php echo isset($guia['id_guia_entrada']) ? $guia['id_guia_entrada'] : ''; ?>" target="_blank" class="btn btn-danger btn-sm shadow-sm" style="padding: 8px 15px; font-family: Verdana, Geneva, Tahoma, sans-serif;">
...
<?php if ($_SERVER["REQUEST_METHOD"] == "POST") : ?>
    ...
    <?php elseif (!empty($guia)) : ?>
        ...
        <div class="col-12 col-sm-6 mb-4">
            <form action="../../../controlador/controlador_tablas/controlador_cambiar_estado_entrada.php" method="POST">
                <input type="hidden" name="id_guia" value="<?php echo $guia['id_guia_entrada']; ?>">
                <button type="submit" class="btn btn-success">Cambiar Estado a Recibido</button>
            </form>
        </div>
    </div>
    <?php endif; ?>
