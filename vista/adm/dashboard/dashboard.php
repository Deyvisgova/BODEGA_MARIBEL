...
<head>
    ...
    <link href="<?= $assetBase ?>/css/sb-admin-2.min.css" rel="stylesheet">
    <link href="<?= $assetBase ?>/css/reloj.css" rel="stylesheet">
</head>

<body id="page-top">
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php?ruta=admin/dashboard">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="index.php?ruta=admin/dashboard">
            ...
            <li class="nav-item"><a class="nav-link" href="vista/adm/dashboard/tabla_admin.php"><i class="fa-solid fa-key"></i> <span>Administradores</span></a></li>
            <li class="nav-item"><a class="nav-link" href="vista/adm/dashboard/tabla_colaborador.php"><i class="fa-solid fa-user"></i> <span>Colaboradores</span></a></li>

            <hr class="sidebar-divider">
            <div class="sidebar-heading text-white">Inventario</div>
            <li class="nav-item"><a class="nav-link" href="vista/adm/dashboard/tabla_producto.php"><i class="fa-solid fa-box"></i> <span>Productos</span></a></li>
            <li class="nav-item"><a class="nav-link" href="vista/adm/dashboard/tabla_checkList.php"><i class="fa-solid fa-list-check"></i> <span>Check List</span></a></li>
            <li class="nav-item"><a class="nav-link" href="vista/adm/dashboard/tabla_categoria.php"><i class="fa-solid fa-layer-group"></i> <span>Categorías</span></a></li>
            <li class="nav-item"><a class="nav-link" href="vista/adm/dashboard/tabla_guia_entrada.php"><i class="fa-solid fa-file-import"></i> <span>Guía de Entrada</span></a></li>
            <li class="nav-item"><a class="nav-link" href="vista/adm/dashboard/tabla_guia_salida.php"><i class="fa-solid fa-file-export"></i> <span>Guía de Salida</span></a></li>

            <hr class="sidebar-divider">
            <div class="sidebar-heading text-white">Proveedores</div>
            <li class="nav-item"><a class="nav-link" href="vista/adm/dashboard/tabla_provedor.php"><i class="fa-solid fa-handshake"></i> <span>Proveedores</span></a></li>

            <hr class="sidebar-divider d-none d-md-block">
            <li class="nav-item">
                <a class="nav-link" href="vista/login/logout.php">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="<?= $assetBase ?>/img/undraw_profile.svg" alt="Perfil">
                            </a>
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="index.php?ruta=admin/dashboard"><i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i> Inicio</a>
                                <a class="dropdown-item" href="vista/login/register_form_adm.php"><i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i> Registrar administrador</a>
                                <a class="dropdown-item" href="vista/login/register_form.php"><i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i> Registrar colaborador</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="vista/login/logout.php"><i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i> Salir</a>
                            </div>
                        </li>
                    </ul>
                </nav>
