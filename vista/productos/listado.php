    ...
    <main class="py-4">
        <div class="container">
            <header class="mb-4 text-center">
                <h1 class="h3 mb-2">Inventario disponible</h1>
                <p class="text-muted">Consulta el stock activo en Bodega Maribel. Cada tarjeta muestra la categoría, precio y unidades restantes.</p>
            </header>
                            ...
                            <div class="card shadow-sm h-100">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <span class="badge bg-primary align-self-start mb-2">
                                        <?php echo htmlspecialchars(trim($producto['categoria']), ENT_QUOTES, 'UTF-8'); ?>
                                    </span>
                                    <h5 class="card-title mb-1"><?php echo htmlspecialchars($producto['nombre_producto'], ENT_QUOTES, 'UTF-8'); ?></h5>
                                    <p class="card-text text-muted mb-3">Stock disponible: <?php echo (int) $producto['cantidad']; ?> unidades.</p>
                                    <p class="card-text fw-bold">S/. <?php echo number_format((float) $producto['precio_producto'], 2, '.', ','); ?></p>
                                    <div class="mt-auto">
                                        <span class="badge bg-success">Inventario activo</span>
                                    </div>
                                </div>
                            </div>
                        </div>
