...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      ?>
      <input type="text" name="dni_adm" required placeholder="Digita tu DNI">
      <input type="text" name="nombre_adm" required placeholder="Digita tu nombre">
      <input type="text" name="apellido_adm" required placeholder="Digita tus apellidos">
      <select name="genero_adm">
         <option value="Masculino">Masculino</option>
         <option value="Femenino">Femenino</option>
      </select>
      <input type="text" name="direccion_adm" required placeholder="Digita tu direccion">
      <input type="text" name="telefono_adm" required placeholder="Digita tu telefono">
